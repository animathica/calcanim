...
class CamposLineales2(Scene):
    ...
    def parte1 (self):
        ...
        titulo=TextMobject('''Cambios de coordenadas \n
                            segunda parte''').scale(2)
        ...
        text2=TextMobject('''Puedes corroborar que cualquier vector descrito en la  \n
                            ...
                            cualquier vector en el plano cartesiano, \n
                            se puede escribir como una combinación lineal de''',''' $\\gamma.$ ''').move_to(2*UP)
        ...
        text5=TextMobject('''En general, podemos escribir cualquier elemento en \n
                            ...
                            con la siguiente transformación''').move_to(1*UP)
    ...
    def parte2 (self):
        ...
        text6=TextMobject('''Veamos que esta función ''traduce'' los vectores de la base''',''' \n
    ...
    def parte4(self):
        ...
        text17=TextMobject('''En conclusión, para considerar una función un cambio de\n
                                 coordenadas,dicha función debe ser biyectiva y \n
                                 cumplir con el diagrama de conmutatividad. ''')
        diagrama = SVGMobject(
