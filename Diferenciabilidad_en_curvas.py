...
class Curvas(GraphScene):
	...
	def show_function_graph(self):
		...
		Titulo = TextMobject("Curvas en el plano")
		...
		Pantalla_1 = VGroup(curva_2, curva_3, Nombre_1, Nombre_2, Nombre_3, Nombre_4, Flecha)
		...
		Pantalla_2 = VGroup(Def_1, Req_1, Req_2)
		...
		self.wait()
		self.play(Write(Decimos_4, run_time = 3), Indicate(Función_Final_P[0], run_time = 3))
		self.wait()
		...
		self.wait(2)
		self.play(ReplacementTransform(Punto_1, Im_Punto_1, run_time = 2))
		self.play(ReplacementTransform(Punto_2, Im_Punto_2, run_time = 2))
		self.play(ReplacementTransform(Punto_3, Im_Punto_3, run_time = 2))
		self.play(ReplacementTransform(Punto_4, Im_Punto_4, run_time = 2))
		self.play(ReplacementTransform(Punto_5, Im_Punto_5, run_time = 2))
		self.play(ReplacementTransform(Punto_6, Im_Punto_6, run_time = 2))
		self.play(ReplacementTransform(Punto_7, Im_Punto_7, run_time = 2))
		self.play(ReplacementTransform(Punto_8, Im_Punto_8, run_time = 2))
		self.play(ReplacementTransform(Punto_9, Im_Punto_9, run_time = 2))
		self.wait(2)
		self.play(FadeOut(Pantalla_3, run_time = 3))
		self.wait(2)