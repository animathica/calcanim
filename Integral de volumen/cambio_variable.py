...
class Cambio_de_Variable_1(Scene):
	...
	def construct(self):
		...
		Area_0 = TextMobject("Empecemos con un caso sencillo, cuando $g$ es lineal.").move_to(3.5 * UP)
		...
		self.play(Write(Area_0, run_time = 2))
		self.wait(2)
		self.play(ReplacementTransform(Area_0,Area_1, run_time = 2))
		self.wait()
		...
		Grafica_Tex_4_0 = TextMobject("Bajo las hipótesis del", " Teorema de Cambio de Variable", ", el área de cada,").next_to(Grafica_Tex_3, DOWN)
		Grafica_Tex_4_1 = TextMobject(" subrectángulo bajo g es", " aproximadamente", " igual al área del subrectángulo").next_to(Grafica_Tex_4_0, DOWN)
		Grafica_Tex_4_2 = TextMobject(" por el valor absoluto del jacobiano en algún punto del subrectángulo,").next_to(Grafica_Tex_4_1, DOWN)
		Grafica_Tex_4_3 = TextMobject(" debido a ello se obtiene la igualdad de las integrales.").next_to(Grafica_Tex_4_2, DOWN)
		Grafica_Tex_4 = VGroup(Grafica_Tex_4_0, Grafica_Tex_4_1, Grafica_Tex_4_2, Grafica_Tex_4_3).scale(0.85)
		Grafica_Tex_4_0[1].set_color(RED_C)
		Grafica_Tex_4_1[1].set_color(RED_C)

		Grafica_Tex = VGroup(Grafica_Tex_2, Grafica_Tex_3, Grafica_Tex_4)
		...
		self.wait(2)
		self.play(Write(Grafica_Tex_4, run_time = 12))
		self.wait()
		self.play(FadeOut(Grafica_Tex, run_time = 3))
		self.wait()

		Hipo_0_Text = TextMobject("Veamos que necesitamos para un caso más general.")
		...
		Hipo_2_Exp_1 = TextMobject("Sólo se puede perder la inyectividad en un conjunto de área cero.").scale(0.85)

		Hipo_3_Text = TextMobject("$\\text{det}(Dg(\\xi))$ debe ser distinto de cero para casi todo punto $x \\in B$").next_to(Hipo_2_Text, DOWN)
		Hipo_3_Exp_1 = TextMobject("El conjunto de puntos críticos D de g debe ser de contenido cero para evitar distorsiones importantes del área.").scale(0.8)
		...
		self.wait()
		self.play(Write(Hipo_0_Text, run_time = 2))
		self.wait()
		self.play(ReplacementTransform(Hipo_0_Text,Hipo_1_Text, run_time = 2))
		self.wait()
...
class Cambio_de_Variable_2(GraphScene):


	CONFIG = {"x_max" : 10,"y_max" : 10,"graph_origin": 3 * DOWN + 2 * LEFT,"axes_color": BLACK,"x_axis_label": None,"y_axis_label": None,}
	...
	def show_function_graph(self):
		...
		Ej_4_Identidad_3 = TextMobject("$g(\\rho, \\theta , \\Phi) = (\\rho \\sin(\\phi)\\cos(\\theta), \\rho \\sin(\\phi)\\sin(\\theta), \\rho \\cos(\\theta))$, ")

		Ej_4_Identidad_4 = TextMobject("$\\rho^2 = x^2 + y^2 + z^2$, ").next_to(Ej_4_Identidad_3, RIGHT)
		...
		Ej_4_Identidad_Nuevo.scale(0.8)
